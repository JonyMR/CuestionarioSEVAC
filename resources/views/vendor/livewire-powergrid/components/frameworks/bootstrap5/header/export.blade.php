...
<div class="dropdown">
  <button class="btn btn-success" wire:click="exportToCsv"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-filetype-csv" viewBox="0 0 16 16">
